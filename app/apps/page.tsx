...
const SECTIONS: { title: string; items: ModuleItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/payroll',       label: 'Payroll',       Icon: IcReceipt, color: '#10b981' },
      { href: '/holiday',       label: 'Holiday & leave', Icon: IcClock, color: '#06b6d4' },
  ...
  {
    title: 'Money & ops (extended)',
    items: [
      { href: '/bank',          label: 'Bank reconciliation', Icon: IcPound, color: '#10b981' },
      { href: '/currency',      label: 'Currency',      Icon: IcPound,   color: '#06b6d4' },
      { href: '/service-catalog', label: 'Service catalog', Icon: IcLayers, color: '#8b5cf6' },
      { href: '/claims',        label: 'Insurance claims', Icon: IcAlert, color: '#ef4444' },
    ],
  },
  {
    ...
    items: [
      ...
      { href: '/carbon',  label: 'Carbon log', Icon: IcLayers, color: '#22c55e' },
      { href: '/waste',   label: 'Waste log',  Icon: IcTruck, color: '#f59e0b' },
    ],
  },
  {
