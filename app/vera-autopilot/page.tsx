    ...
    <div className="module-page" style={{ background: 'var(--bg0)', minHeight: '100dvh', paddingBottom: 100 }}>
      ...
      <div style={{ padding: '16px 20px' }}>
        ...
        <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: 8 }}>
          {items.map(a => (
            <li key={a.id} style={{ background: 'var(--surface-raised)', borderRadius: 12, padding: 14, border: '0.5px solid rgba(255,255,255,0.07)', fontFamily: 'var(--font-system)' }}>
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10 }}>
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 4 }}>
                    <span style={{ fontSize: 14, color: 'var(--t1)', fontWeight: 700 }}>{a.title}</span>
                  ...
                  <p style={{ fontSize: 12, color: 'var(--t2)', margin: '0 0 8px', lineHeight: 1.4 }}>{a.description}</p>
                  <div style={{ fontSize: 11, color: 'var(--t3)', fontFamily: 'ui-monospace, monospace' }}>
                    when: {a.trigger}<br />
                    then: {a.action}
                  </div>
                </div>
                <button
                  ...
                  style={{
                    ...
                    color: a.enabled ? 'var(--bg0)' : 'var(--t2)',
                    fontSize: 11,
                    fontWeight: 700,
                    cursor: 'pointer',
