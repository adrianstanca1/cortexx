...
export async function GET(_req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    const item = await prisma.actionPlan.findUnique({ where: { id } })
  ...
  try {
    ...
    const item = await prisma.actionPlan.update({
      ...
      data: {
        ...
        ...(typeof body.closeOutNotes === 'string' ? { closeOutNotes: body.closeOutNotes.trim() } : {}),
