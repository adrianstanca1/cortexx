...
const ARTICLES: Article[] = [
  {
    ...
    body: [
      ...
      '5. Assign each teammate a construction role: company admin, project manager, foreman, operative, client or viewer. See "Team roles" below.',
    ],
  },
  {
    slug: 'team-roles',
    title: 'Team roles',
    oneLiner: 'Company Admin → Project Manager → Foreman → Operative, with separate Client/Viewer access.',
    body: [
      'Owner — tenant owner. Has company-admin rights plus billing, ownership transfer and workspace deletion. The workspace must always retain at least one owner.',
      'Company Admin — full company tools and settings, creates projects, invites users, sets roles and controls company-level commercial data.',
      'Project Manager — manages assigned projects, tasks, approvals, procurement creation, drawings, quality and the full safety workflow. Project Managers cannot create new projects.',
      'Foreman — site-lead role for daily tasks, team coordination, site records, drawings, safety and quality capture without company-level finance/settings authority.',
      'Operative — field-focused role for assigned work, clocking time, documents/photos, drawings, safety observations and quality records.',
      'Client / Viewer — restricted read or approval access without internal operational permissions.',
