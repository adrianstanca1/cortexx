      ...
      <div style={{ flex: 1, overflowY: 'auto', paddingBottom: 150 }}>
        <MobileHeader
          ...
          right={<div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
            <HeaderBtn icon={Ic.search} onClick={() => window.cortexxNav && window.cortexxNav('search')}/>
            <HeaderBtn icon={Ic.bell} count={(window.CortexPortalMsgs&&window.CortexPortalMsgs.unreadCount())||0} accent={accent} onClick={() => window.cortexxNav && window.cortexxNav('inbox')}/>
          </div>}
        />
    ...
    <ScreenBg accent={accent}>
      <div style={{ flex: 1, overflowY: 'auto', paddingBottom: 150 }}>
        ...
        <div style={{ padding: '0 16px 12px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
          {[
            { l: 'Check in', s: 'GPS log hours', c: T.green, i: Ic.pin, route: 'clock' },
            { l: 'Receipt', s: 'Scan + assign', c: T.purple, i: Ic.receipt, route: 'scan' },
