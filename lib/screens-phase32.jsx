...
function CommandPalette({ onClose, accent }) {
  ...
  const ALL = [
    ...
    { l: 'Payments ledger', k: 'payments', i: Ic.money, c: T.green },
    ...
    { l: 'Client messages', k: 'clientmsgs', i: Ic.chat || Ic.bell, c: T.purple },
    ...
    { l: 'Switch workspace', k: 'switchworkspace', i: Ic.swap, c: T.purple },
    { l: 'New workspace', k: 'newworkspace', i: Ic.plus, c: T.cyan },
    { l: 'Notifications', k: 'notifprefs', i: Ic.bell, c: T.blue },
    { l: 'Digests',       k: 'digests', i: Ic.send, c: T.purple },
    { l: 'Export data',   k: 'dataexport', i: Ic.download, c: T.cyan },
    { l: 'Ledger export', k: 'ledger', i: Ic.receipt || Ic.money, c: T.green },
    { l: 'Audit log',     k: 'auditlog', i: Ic.archive, c: T.purple },
    { l: 'Billing & usage', k: 'billing', i: Ic.money, c: T.green },
    { l: 'Sign in / SSO', k: 'sso', i: Ic.shield, c: T.blue },
    { l: 'Cloud sync',    k: 'cloudsync', i: Ic.zap, c: T.cyan },
    { l: 'AI engine',     k: 'aiengine', i: Ic.spark, c: T.purple },
