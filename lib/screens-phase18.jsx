  ...
  if (section === null) {
    return <ScreenBg accent={accent}>
      <div style={{ flex: 1, overflowY: 'auto', paddingBottom: 30 }}>
        <MobileHeader title="About & legal" subtitle="CortexBuild Pro v2.0 · build 247 · production-ready"/>
      ...
      {section === 'privacy' && (
        <div style={{ padding: '0 16px 30px', fontFamily: SF, fontSize: 14, color: T.t1, lineHeight: 1.6 }}>
          <div style={{ background: T.bg2, borderRadius: 14, padding: 16, border: `0.5px solid ${T.hair}` }}>
            <p><strong>CortexBuild Pro is local-first.</strong> Your data lives on your device, not on our servers. We use Claude's API for AI features, with no training opt-in. Read more:</p>
      ...
      {section === 'terms' && (
        <div style={{ padding: '0 16px 30px' }}>
          <div style={{ background: T.bg2, borderRadius: 14, padding: 16, border: `0.5px solid ${T.hair}`, fontFamily: SF, fontSize: 14, color: T.t1, lineHeight: 1.6 }}>
            <p>By using CortexBuild Pro you agree to use it for lawful UK construction operations. You retain all rights to your data. We provide the software "as is" with reasonable uptime guarantees on paid plans.</p>
