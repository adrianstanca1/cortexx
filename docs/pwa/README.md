...
- **12 dashboard layouts** — Action-first, Status board, Calm, Bento, AI-forward, Field, Timeline, Books, Stories, Rings, Map, Focus, Executive
...
│   ├── dashboards*.jsx          12 dashboard layouts
...
All AI runs via `window.claude.complete` (Claude Haiku 4.5, server-proxied — no API keys exposed).
