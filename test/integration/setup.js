...
async function truncate(prisma) {
  ...
  await tenancy.bypassTenancy(async () => {
    const TABLES = [
      ...
      'DrawingDistributionRecipient', 'DrawingDistribution', 'DrawingRevision', 'Drawing', 'ProgrammeResourceAllocation', 'ProgrammeDependency', 'ProgrammeDelayEvent', 'ProgrammeBaselineRevision', 'ProgrammeActivity', 'Milestone', 'ExpenseReceipt', 'Document', 'CostCode', 'CostItem',
