...
function LaunchScreen({
  ...
  if (section === null) {
    return React.createElement(ScreenBg, {
      ...
      title: "About & legal",
      subtitle: "Cortexx v2.0 \xB7 build 247 \xB7 production-ready"
    }), React.createElement("div", {
      style: {
  ...
  return React.createElement(ScreenBg, {
  ...
  }, React.createElement("p", null, React.createElement("strong", null, "Cortexx is local-first."), " Your data lives on your device, not on our servers. We use Claude's API for AI features, with no training opt-in. Read more:"), React.createElement("ul", {
    style: {
      paddingLeft: 18,
      marginTop: 10
    }
  ...
  }, React.createElement("p", null, "By using Cortexx you agree to use it for lawful UK construction operations. You retain all rights to your data. We provide the software \"as is\" with reasonable uptime guarantees on paid plans."), React.createElement("p", {
    style: {
      marginTop: 10
    }
    ...
    iconBg: T.amber,
    title: "Bug bounty",
    sub: "Report vulnerabilities: security@cortexx.app",
    isLast: true
