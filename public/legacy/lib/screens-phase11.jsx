...
(function() {
  ...
  if (!snap.clockEntries) {
    snap.clockEntries = [
      { id: 1, userId: 1, name: 'Tom Reilly',    projectId: 1, action: 'in',  time: '2026-05-22T07:30', method: 'gps', gps: { lat: 51.541, lng: -0.143 }, location: 'Camden Mews' },
      { id: 2, userId: 2, name: 'Aisha Begum',   projectId: 1, action: 'in',  time: '2026-05-22T07:45', method: 'gps', gps: { lat: 51.541, lng: -0.143 }, location: 'Camden Mews' },
      { id: 3, userId: 3, name: 'Jack Mitchell', projectId: 1, action: 'in',  time: '2026-05-22T08:00', method: 'gps', gps: { lat: 51.541, lng: -0.143 }, location: 'Camden Mews' },
      { id: 4, userId: 4, name: 'Sara Khan',     projectId: 1, action: 'in',  time: '2026-05-22T08:15', method: 'qr',  gps: null,                       location: 'Camden Mews' },
      { id: 5, userId: 5, name: 'Marcus Webb',   projectId: 2, action: 'in',  time: '2026-05-22T08:00', method: 'gps', gps: { lat: 51.546, lng: -0.057 }, location: 'Hackney Loft' },
      { id: 6, userId: 7, name: 'Dan Pavel',     projectId: 2, action: 'in',  time: '2026-05-22T08:05', method: 'gps', gps: { lat: 51.546, lng: -0.057 }, location: 'Hackney Loft' },
      // Lunch break entries
      { id: 7, userId: 1, name: 'Tom Reilly',    projectId: 1, action: 'break-out', time: '2026-05-22T12:30', method: 'manual', gps: null, location: 'Camden Mews' },
      { id: 8, userId: 1, name: 'Tom Reilly',    projectId: 1, action: 'break-in',  time: '2026-05-22T13:00', method: 'manual', gps: null, location: 'Camden Mews' },
    ];
