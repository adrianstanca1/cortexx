...
export const { login, getMe, getProjects, apiGet, apiPost, getCollection, postCollection, putCollection, postCisSub, onQueueChange, pendingWrites, flushQueue, getToken, setToken, clearToken } = api;
