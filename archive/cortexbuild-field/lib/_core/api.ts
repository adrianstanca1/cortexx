...
export async function apiCall<T>(endpoint: string, options: RequestInit = {}): Promise<T> {
  ...
  if (Platform.OS !== "web") {
    ...
    debugLog("[API] apiCall:", { endpoint, platform: "web", method: options.method || "GET" });
  }
  ...
  try {
    ...
    if (DEBUG_API && response.headers.get("Set-Cookie")) {
      debugLog("[API] Set-Cookie header received");
    }
