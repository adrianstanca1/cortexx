(function () {
  ...
  window.AddInvoiceSheet = function ({
    ...
    return React.createElement(ShW, {
      title: 'New Invoice',
      onClose,
      onSave: save,
      saving
    ...
    }, ['0', '5', '20'].map(r => React.createElement('option', {
      key: r,
      value: r
    ...
    }, ['draft', 'sent', 'paid', 'overdue'].map(s => React.createElement('option', {
      key: s,
      value: s
    }, s.charAt(0).toUpperCase() + s.slice(1))))), React.createElement(Field, {
      label: 'Retention %'
    }, React.createElement('input', {
      style: inp(),
      type: 'number',
  ...
  window.AddQuoteSheet = function ({
    ...
    return React.createElement(ShW, {
      ...
      key: p.id,
      value: p.id
    }, p.name + ' — ' + p.client)))), React.createElement(Field, {
      label: 'Quote title'
    }, React.createElement('input', {
      style: inp(),
      placeholder: 'e.g. Kitchen refurbishment works',
      value: form.title,
      ...
      value: form.status,
      onChange: e => set('status', e.target.value)
    }, ['draft', 'sent', 'won', 'lost'].map(s => React.createElement('option', {
      key: s,
      value: s
    }, s.charAt(0).toUpperCase() + s.slice(1))))), React.createElement(Field, {
  ...
  window.AddReceiptSheet = function ({
    ...
    return React.createElement(ShW, {
      ...
      style: inp(),
      placeholder: 'Travis Perkins, Screwfix…',
      value: form.vendor,
      ...
      key: c,
      value: c
    }, c.charAt(0).toUpperCase() + c.slice(1).replace('-', ' '))))), React.createElement(Field, {
      label: 'Project'
    }, React.createElement('select', {
      style: sel(),
      value: form.projectId,
  ...
  window.AddPOSheet = function ({
    ...
    return React.createElement(ShW, {
      ...
      label: 'Description of goods / works'
    }, React.createElement('textarea', {
      style: {
        ...inp(),
        minHeight: 70,
      ...
      value: form.status,
      onChange: e => set('status', e.target.value)
    }, ['pending', 'approved', 'ordered', 'delivered', 'cancelled'].map(s => React.createElement('option', {
      key: s,
      value: s
  ...
  window.AddIncidentSheet = function ({
    ...
    return React.createElement(ShW, {
    ...
    }, ['near-miss', 'first-aid', 'medical', 'dangerous-occurrence', 'property-damage', 'environmental'].map(t => React.createElement('option', {
      key: t,
      value: t
    }, t.replace(/-/g, ' ').replace(/\b\w/g, c => c.toUpperCase()))))), React.createElement(Field, {
      label: 'Severity'
    }, React.createElement('select', {
      style: sel(),
      value: form.severity,
      onChange: e => set('severity', e.target.value)
    }, ['minor', 'moderate', 'serious', 'fatal'].map(s => React.createElement('option', {
      key: s,
      value: s
    }, s.charAt(0).toUpperCase() + s.slice(1)))))), React.createElement('div', {
      style: {
        display: 'grid',
        gridTemplateColumns: '1fr 1fr',
        gap: 12
      ...
      label: 'Person(s) involved (if any)'
    }, React.createElement('input', {
      style: inp(),
      ...
      placeholder: 'What happened, where, how?',
      value: form.description,
      onChange: e => set('description', e.target.value)
    })), React.createElement(Field, {
      ...
      placeholder: 'First aid, area made safe, etc.',
  ...
  window.StorageCapacityBanner = function ({
    ...
    }, usage.pct >= 95 ? '🚨' : '⚠️'), React.createElement('div', {
      style: {
        flex: 1
      }
    }, React.createElement('div', {
    ...
    }, usage.pct >= 95 ? 'Storage almost full!' : 'Storage ' + usage.pct + '% used'), React.createElement('div', {
      style: {
        color: T.t2,
        fontSize: 12
      }
