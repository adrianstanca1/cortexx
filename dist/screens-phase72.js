...
function ImproveStat({
  ...
  }, positive ? '▲' : '▼', " ", Math.abs(delta), "%")), sub && React.createElement("div", {
    style: {
      fontFamily: SF,
      fontSize: 10.5,
      color: T.t2,
...
function GoalBar({
  ...
  const ratio = lower ? Math.min(1, target / Math.max(value, target)) : Math.min(1, value / Math.max(target, 1));
...
function ImproveHubScreen({
  ...
  }, "Running impact \xB7 YTD")), React.createElement("div", {
    style: {
      fontFamily: SFMono,
      fontSize: 30,
      fontWeight: 700,
  ...
  }, cashImpact, " ", React.createElement("span", {
    style: {
      color: T.t3,
      fontSize: 14,
      fontWeight: 500
    }
  }, "realised")), React.createElement("div", {
    style: {
      fontFamily: SF,
      fontSize: 12,
      color: T.t2,
  ...
  }, live.length, " initiatives in production \xB7 ", live.reduce((s, i) => s + i.wins, 0), " wins logged \xB7 Vera proposed ", ideas.length, " more this week."))), React.createElement("div", {
    style: {
      padding: '0 16px 14px',
      display: 'flex',
      gap: 8
    }
  }, React.createElement(ImproveStat, {
    label: "Avg margin",
    value: `${avgMargin}%`,
  ...
  }, React.createElement(SectionLabel, null, "Improve across"), React.createElement(GroupedList, null, React.createElement(Row, {
    icon: Ic.layers,
    iconBg: accent,
  ...
  }, React.createElement(SectionLabel, null, "Recent wins"), React.createElement("div", {
    style: {
      display: 'flex',
  ...
  }, w.owner, " \xB7 ", w.wins, " wins logged")), React.createElement("div", {
    style: {
      textAlign: 'right',
      whiteSpace: 'nowrap'
    }
  ...
  }, w.impact), React.createElement("div", {
    style: {
      fontFamily: SFMono,
      fontSize: 10,
      color: T.t3,
  ...
  }, w.before, w.unit, " ", React.createElement("span", {
    style: {
      color: T.t2
    }
  }, "\u2192"), " ", w.after, w.unit))))))), React.createElement("div", {
    style: {
      padding: '0 16px 30px'
    }
  }, React.createElement("div", {
  ...
  }, "Vera proposes")), React.createElement("div", {
    style: {
      fontFamily: SF,
      fontSize: 13,
      color: T.t1,
  ...
  }, "Variation orders are your slowest process at 48h vs 24h target. In-app signature would close ", React.createElement("span", {
    style: {
      color: T.green,
      fontFamily: SFMono
    }
  }, "~24h"), " per job and unlock ", React.createElement("span", {
    style: {
      color: T.green,
      fontFamily: SFMono
    }
...
function ServiceCatalogScreen({
  ...
  return React.createElement(ScreenBg, {
    ...
    }, svc.name)), React.createElement("div", {
      style: {
        fontFamily: SF,
        fontSize: 11,
        color: T.t3,
    ...
    }, svc.lane), React.createElement("span", {
      style: {
        marginLeft: 6
      }
    }, svc.owner, " \xB7 ", svc.lastQ, " sold last quarter"))), React.createElement(Spark, {
      data: svc.trend,
...
function MetricBlock({
  ...
  }, targetLine), React.createElement(GoalBar, {
    value: barValue,
    target: barTarget,
    lower: lower,
    color: color
...
function ProcessLibraryScreen({
  ...
  return React.createElement(ScreenBg, {
    ...
    }, p.version)), React.createElement("div", {
      style: {
        fontFamily: SF,
        fontSize: 11,
        color: T.t3
      }
    }, p.steps, " steps \xB7 ", p.owner, " \xB7 ", p.runs, " runs \xB7 last edit ", p.updated)), React.createElement("div", {
      style: {
        textAlign: 'right',
        whiteSpace: 'nowrap'
      }
    ...
    }, fmtHrs(p.cycleHrs)), React.createElement("div", {
      style: {
        fontFamily: SFMono,
        fontSize: 10,
        color: T.t3
      }
    }, "vs ", fmtHrs(p.cycleTarget), overTarget ? ` · +${slipPct}%` : ''))), React.createElement("div", {
      style: {
        marginTop: 10,
        display: 'flex',
        alignItems: 'center',
...
function KaizenBoardScreen({
  ...
  return React.createElement(ScreenBg, {
    ...
    }, React.createElement("span", null, L.l), React.createElement("span", {
      style: {
        fontFamily: SFMono,
        fontSize: 13,
        fontWeight: 700
    ...
    }, it.owner, " \xB7 started ", it.started, it.wins > 0 ? ` · ${it.wins} wins` : ''), React.createElement("div", {
      style: {
        fontFamily: SFMono,
        fontSize: 11,
        fontWeight: 700,
    ...
    }, it.impact)), it.after != null && React.createElement("div", {
      style: {
        marginTop: 10,
        padding: '8px 10px',
        background: T.bg1,
    ...
    }, it.metric), React.createElement("div", {
      style: {
        display: 'flex',
        alignItems: 'center',
        gap: 6,
    ...
    }, it.before, it.unit), React.createElement("span", {
      style: {
        color: T.t3
      }
    ...
    }, it.after, it.unit), React.createElement("span", {
      style: {
        fontFamily: SFMono,
        fontSize: 11,
        fontWeight: 600,
    ...
    }, it.delta > 0 ? '+' : '', it.delta, it.unit === '%' || it.unit === 'd' || it.unit === 'h' ? it.unit : ''))), it.after == null && React.createElement("div", {
      style: {
        marginTop: 10,
        padding: '8px 10px',
        background: T.bg1,
    ...
    }, "Baseline: ", React.createElement("span", {
      style: {
        fontFamily: SFMono,
        color: T.t1
      }
