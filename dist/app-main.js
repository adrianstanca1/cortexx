...
function CortexxApp({
  ...
  return React.createElement("div", {
    ...
    onClose: closeSheet,
    accent: accent
  }), sheet === 'addhandover' && React.createElement(HandoverSheet, {
    onClose: closeSheet,
    accent: accent
  }), sheet === 'addtakeoff' && React.createElement(TakeoffSheet, {
    onClose: closeSheet,
    accent: accent
  }), sheet === 'addbid' && React.createElement(BidSheet, {
    onClose: closeSheet,
    accent: accent
  }), sheet === 'requestsurvey' && React.createElement(SurveySheet, {
    onClose: closeSheet,
    accent: accent
  }), sheet === 'scheduleaudit' && React.createElement(AuditSheet, {
    onClose: closeSheet,
    accent: accent
