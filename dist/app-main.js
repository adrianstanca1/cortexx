  ...
  React.useEffect(() => {
    window.cortexxNav = (key, payload) => {
      ...
      if (key === 'project') {
        ...
        setActiveProject(payload);
        setSheet('editfield');
      } else if (key === 'smartparse' || key === 'parse') setSheet('smartparse');else if (key === 'phototosnag') setSheet('phototosnag');else if (key === 'starttrip') setSheet('starttrip');else if (key === 'addtag') setSheet('addtag');else if (key === 'addtemplate') setSheet('addtemplate');else if (key === 'addview') setSheet('addview');else if (key === 'addcost') setSheet('addcost');else if (key === 'tab') {
        setTab(payload);
        setSheet(null);
      } else {
        setSheet(key);
