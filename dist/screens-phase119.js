(function (root) {
  ...
  function BuildAppGrid() {
    ...
    function label(k) {
      return k.replace(/([a-z])([A-Z])/g, '$1 $2').replace(/[-_]/g, ' ').replace(/\b\w/g, function (c) {
  ...
  function AppGridSheet(props) {
    ...
    }, Object.keys(built.groups).map(function (name) {
      return Section(name, built.groups[name]);
    })));
  }
  root.AppGridSheet = AppGridSheet;
  if (typeof module !== 'undefined' && module.exports) module.exports = {
    AppGridSheet: AppGridSheet
  };
