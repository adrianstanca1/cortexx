...
function SignatureSheet({
  ...
  return /*#__PURE__*/React.createElement(Sheet, {
    ...
    style: {
      background: 'none',
      border: 'none',
      color: hasSignature ? accent : T.t3,
      fontFamily: SF,
      fontSize: 16,
      fontWeight: 600,
    ...
    style: {
      flex: 2,
      background: hasSignature ? T.green : T.bg3,
      color: '#fff',
      border: 'none',
      borderRadius: 12,
      padding: '12px',
  ...
  return /*#__PURE__*/React.createElement(Sheet, {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        height: 28,
        borderRadius: 14,
        background: a.status === 'pending' ? T.bg3 : c,
        color: '#fff',
    ...
    }, a.status.toUpperCase(), " \xB7 ", new Date(a.when).toLocaleString('en-GB', {
      day: '2-digit',
      month: 'short',
      hour: '2-digit',
      minute: '2-digit'
