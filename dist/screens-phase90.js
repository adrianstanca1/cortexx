...
(function () {
  ...
  window.CortexPayments = {
    ...
    add(p) {
      ...
      try {
        localStorage.setItem(KEY(), JSON.stringify(l.slice(0, 300)));
      } catch (e) {}
      return l;
    }
  };
...
function RecordPaymentSheet({
  ...
  return /*#__PURE__*/React.createElement(Sheet, {
    ...
    style: {
      background: method === m.k ? `${accent}14` : T.bg2,
      border: `0.5px solid ${method === m.k ? accent : T.hair}`,
      borderRadius: 10,
      padding: '12px',
      cursor: 'pointer',
      fontFamily: SF,
