...
(function () {
  ...
  Backend.personas = {
    vera: {
      name: 'Vera Stone',
      role: 'CEO',
      style: 'decisive, strategic, big picture',
      initials: 'VS',
      c: '#8b5cf6'
    },
    marcus: {
      name: 'Marcus Pound',
      role: 'CFO',
      style: 'numbers-first, cautious, UK CIS expert',
      initials: 'MP',
      c: '#10b981'
    },
    pip: {
      name: 'Pip Carter',
      role: 'Site Manager',
      style: 'practical, blunt, safety-aware',
      initials: 'PC',
      c: '#f59e0b'
    },
    ada: {
      ...
      style: 'meticulous, regulation-quoting',
      initials: 'AW',
      c: '#ef4444'
    },
    river: {
      name: 'River Ng',
      role: 'Sales Director',
      style: 'warm, persuasive, customer-led',
      initials: 'RN',
      c: '#06b6d4'
    }
  };
  Backend.askPersona = async (key, question) => {
    const p = Backend.personas[key];
    if (!p) return null;
