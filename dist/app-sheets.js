...
function ProjectSheet({
  ...
  return React.createElement(Sheet, {
    ...
    onClick: async () => {
      if (editing) {
        await Backend.db.projects.update(project.id, {
          ...
          client: draft.client,
          addr: draft.addr,
          value: parseInt(draft.value) || project.value,
          status: draft.status,
    ...
    l: 'Margin',
    v: project.margin > 0 ? project.margin + '%' : '—',
    c: T.green
  }, {
    l: 'Team',
    v: project.team || '—',
    ...
    t: 'First fix electrical',
    s: 'Apr 18 · 8 days',
    state: 'done'
  }, {
    t: 'Plastering',
    s: 'In progress · 4 days left',
    state: 'active'
  }, {
    t: 'Second fix + finishes',
    s: 'May 7-15',
    state: 'pending'
  }, {
    t: 'Snagging & handover',
    ...
    n: 'Building_Reg_Approval.pdf',
    s: '890 KB'
  }, {
    n: 'Quote_Final_Signed.pdf',
    s: '1.1 MB'
  }, {
    n: 'Material_Order_W17.xlsx',
    s: '34 KB'
  }, {
...
function CaptureSheet({
  ...
  const captureOpts = [{
    k: 'smartparse',
    t: 'Smart parse',
    d: 'Paste anything → structured records',
    i: Ic.spark,
    c: T.purple,
    ai: true
  }, {
    ...
    k: 'task',
    t: 'New task',
    d: 'Quick add to your queue',
    i: Ic.tasks,
    c: T.purple
  }, {
    k: 'estimate',
    t: 'AI estimate',
    d: 'Brief in → quote out',
    i: Ic.calc,
    c: T.blue,
    ai: true
  }, {
    k: 'photomention',
    t: 'Photo → actions',
    d: 'Drop a photo · AI extracts tasks/snags/RFIs',
    i: Ic.camera,
    c: T.cyan,
    ai: true
  }, {
    k: 'photo',
    t: 'Site progress photo',
    d: 'Geo-tagged · added to project',
    i: Ic.camera,
    c: T.blue
  }, {
    k: 'phototosnag',
    t: 'Snag from photo',
    d: 'AI detects defects · auto-files',
    i: Ic.alert,
    c: T.amber,
    ai: true
  }, {
    ...
    k: 'voice',
    t: 'Voice note / RFI',
    d: 'Transcribed by Cortex',
    i: Ic.mic,
    c: T.cyan
  }, {
    k: 'checkin',
    t: 'Site check-in',
    d: 'GPS verified · logs hours',
    i: Ic.pin,
    c: T.green
  }, {
    k: 'attendance',
    t: 'On site now',
    d: 'Live attendance board',
    i: Ic.team || Ic.users,
    c: T.green
  }, {
    k: 'nfctags',
    t: 'NFC site tags',
    d: 'Tap-to-check-in at the gate',
    i: Ic.pin,
    c: T.cyan
  }, {
    k: 'labels',
    t: 'Label printer',
    d: 'Delivery, asset & QR labels',
    i: Ic.print || Ic.doc,
    c: T.cyan
  }, {
    k: 'sitemap',
    t: 'Site map',
    d: 'Offline map + markup',
    i: Ic.pin || Ic.map,
    c: T.green
  }, {
    k: 'incident',
    t: 'Report incident',
    d: 'Notify HSE if required',
    i: Ic.alert,
    c: T.red
  }];
  const appGroups = [{
    ...
    items: [{
      ...
      i: Ic.receipt,
      c: T.amber,
      badge: useComputed('openPOs')
    }, {
      k: 'subinvoices',
      t: 'Sub invoices',
      i: Ic.receipt,
      c: T.amber,
      badge: useComputed('pendingSubInvoices')
    }, {
      k: 'materials',
      t: 'Materials',
      i: Ic.box,
    ...
    items: [{
      ...
      i: Ic.hardhat,
      c: T.amber,
      badge: useComputed('certExpiring')
    }, {
      k: 'roles',
      t: 'Roles',
      i: Ic.shield,
    ...
    items: [{
      ...
      i: Ic.check,
      c: T.green,
      badge: useComputed('openInspections')
    }, {
      k: 'audittrail',
      t: 'Audit trail',
      i: Ic.archive,
...
function AISheet({
  ...
  const [messages, setMessages] = React.useState([{
    who: 'ai',
    t: "Morning Adrian. Camden is on track for Friday handover. You're £8.4k up this week. What can I help you decide?"
  }]);
  ...
  const speak = (text, idx) => {
    if (!('speechSynthesis' in window)) {
      toast('Text-to-speech not supported here', 'info');
      return;
    }
    if (speakingIdx === idx) {
  ...
  const toggleVoice = () => {
    ...
    if (!SR) {
      toast('Voice input not supported on this device', 'info');
      return;
    }
    if (listening) {
  ...
  const suggestions = ["What's my margin on Camden so far?", "Forecast next month's cashflow", "Who's available to cover Brixton?"];
  ...
  return React.createElement(Sheet, {
    ...
    style: {
      ...
      padding: '4px 6px',
      marginTop: 2,
      color: speakingIdx === i ? accent : T.t3,
      fontFamily: SF,
      fontSize: 11,
      fontWeight: 600,
      display: 'flex',
    ...
    style: {
      flex: 1,
      background: T.bg2,
      border: `0.5px solid ${listening ? T.red + '66' : T.hairMid}`,
      borderRadius: 18,
      padding: '10px 14px',
      color: T.t1,
      fontFamily: SF,
    ...
    style: {
      ...
      borderRadius: 18,
      flexShrink: 0,
      background: input.trim() && !thinking ? accent : T.bg3,
      border: 'none',
      color: '#fff',
