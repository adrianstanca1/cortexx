...
(function () {
  ...
  if (snap.team && !snap.team[0].certificates) {
    const ext = {
      1: {
        ...
        emergency: 'Jane Reilly · 07900 100 002',
        startDate: '2023-04-12',
        dob: '1985-06-14',
        address: 'Camden, NW1',
        dayRate: 280,
        bio: 'Site foreman with 12 yrs experience in residential refurb.',
        certificates: [{
          id: 1,
          name: 'CSCS Gold',
          issued: '2024-03',
      ...
      2: {
        ...
        emergency: 'Yusuf B · 07900 100 004',
        startDate: '2023-09-01',
        dob: '1991-11-22',
        address: 'Hackney, E8',
        dayRate: 240,
        bio: 'Approved electrician, 18th edition. NICEIC member.',
        certificates: [{
          id: 1,
          name: 'CSCS Blue (Skilled)',
          issued: '2024-01',
          expires: '2029-01',
          issuer: 'CITB',
          status: 'valid',
          ...
          id: 3,
          name: 'EAL Level 3 Inspection & Testing',
          issued: '2023-04',
          expires: 'lifetime',
          issuer: 'EAL',
          status: 'valid',
      ...
      3: {
        phone: '07900 100 005',
        email: 'jack@cortexbuild.app',
        emergency: 'Eve Mitchell · 07900 100 006',
        startDate: '2024-02-15',
        dob: '1989-03-08',
        address: 'Walthamstow, E17',
        dayRate: 220,
        bio: 'Master plasterer, specialises in heritage finishes.',
        certificates: [{
          id: 1,
          name: 'CSCS Blue',
          issued: '2024-03',
      ...
      4: {
        phone: '07900 100 007',
        email: 'sara@cortexbuild.app',
        emergency: 'Khan family · 07900 100 008',
        startDate: '2025-09-01',
        dob: '2003-07-30',
        address: 'Camden, NW1',
        dayRate: 110,
        bio: 'Apprentice in second year. Eager and reliable.',
        certificates: [{
          id: 1,
          name: 'CSCS Green (Trainee)',
          issued: '2024-09',
          expires: '2025-09',
          issuer: 'CITB',
          status: 'expiring',
      ...
      5: {
        ...
        emergency: 'Webb family · 07900 100 010',
        startDate: '2023-01-20',
        dob: '1982-09-19',
        address: 'Tottenham, N17',
        dayRate: 260,
        bio: 'Carpenter and joiner, 20 yrs in trade.',
        certificates: [{
          id: 1,
          name: 'CSCS Gold',
          issued: '2023-02',
      ...
      6: {
        phone: '07900 100 011',
        email: 'lila@cortexbuild.app',
        emergency: 'Owusu family · 07900 100 012',
        startDate: '2024-06-01',
        dob: '1995-04-11',
        address: 'Brixton, SW9',
        dayRate: 200,
        bio: 'Painter & decorator, fine finishes.',
        certificates: [{
          id: 1,
          name: 'CSCS Blue',
          issued: '2024-06',
      ...
      7: {
        phone: '07900 100 013',
        email: 'dan@cortexbuild.app',
        emergency: 'Maria P · 07900 100 014',
        startDate: '2024-11-01',
        dob: '1998-08-25',
        address: 'Hackney, E8',
        dayRate: 130,
        bio: 'General labourer, learning every trade.',
        certificates: [{
          id: 1,
          name: 'CSCS Green',
          issued: '2024-11',
  ...
  Backend.db.removeCertificate = async (memberId, certId) => {
    ...
    s.team = s.team.map(m => m.id == memberId ? {
      ...m,
      certificates: (m.certificates || []).filter(c => c.id !== certId)
    } : m);
    try {
      localStorage.setItem('cortexx_db_v1', JSON.stringify(s));
    } catch (e) {}
...
function TeamMemberSheet({
  ...
  const save = async () => {
    await Backend.db.updateMember(member.id, {
      ...
      dayRate: parseFloat(draft.dayRate) || live.dayRate,
      bio: draft.bio,
...
function AddCertSheet({
  ...
  return /*#__PURE__*/React.createElement(FormSheet, {
    ...
    options: [{
      ...
      v: 'IPAF',
      l: 'IPAF (Powered access)'
    }, {
      v: 'PASMA',
      l: 'PASMA (Towers)'
    }, {
      v: '18th Edition',
      l: '18th Edition Wiring Regs'
    }, {
      v: 'Gas Safe',
      l: 'Gas Safe'
    }, {
    ...
    size: 14
  }), " Attach scan / photo of certificate"));
}
