...
(function () {
  if (!window.Backend) {
    console.warn('Backend not loaded');
    return;
  }
  ...
  const EXTRAS = {
    quotes: [{
      ...
      projectId: 4,
      client: 'B. Khoury',
      title: 'Islington 2-storey extension',
      total: 96000,
      status: 'sent',
      issued: '2026-05-18',
      validUntil: '2026-06-18',
      items: [{
        d: 'Strip-out & demolition',
        qty: 1,
        unit: 'lot',
        rate: 4500
      }, {
        d: 'Foundations & ground works',
        qty: 1,
        unit: 'lot',
        rate: 18000
      }, {
      ...
      projectId: null,
      client: 'M. Ortiz',
      title: 'Kitchen refit · Shoreditch',
      total: 22500,
      status: 'draft',
      issued: '2026-05-20',
      ...
      projectId: null,
      client: 'K. Daniels',
      title: 'Loft conversion · Highbury',
      total: 58000,
      status: 'accepted',
      issued: '2026-05-02',
      validUntil: null,
    ...
    materials: [{
      id: 1,
      name: 'Plasterboard 12.5mm 2.4×1.2m',
      sku: 'PB-12-24',
      stock: 18,
      unit: 'sheets',
      min: 12,
      ...
      id: 3,
      name: 'Insulation 100mm 1200×600',
      sku: 'INS-100',
      stock: 34,
      unit: 'boards',
      min: 20,
    ...
    diary: [{
      ...
      present: 4,
      summary: 'First-fix electrical signed off in kitchen. Plasterboard delivery delayed — Tom chasing supplier.',
      notes: 'Aisha completed kitchen socket runs. Sara assisting Jack with plasterboard prep on ground floor.',
      photos: 4,
      issues: ['plasterboard late']
    }, {
      id: 2,
      projectId: 1,
      date: '2026-05-21',
      ...
      present: 4,
      summary: 'Strong day. Most of ground floor plasterboard up. Skip swap done at 14:00.',
      notes: '',
      photos: 6,
      issues: []
    }, {
      ...
      present: 3,
      summary: 'Wet day — focused on indoor work. Electrical first fix ~80% complete.',
      notes: '',
      photos: 2,
      issues: ['Sara off (sick)']
    }, {
      id: 4,
      projectId: 2,
      date: '2026-05-22',
      ...
      present: 2,
      summary: 'Loft floor joists installed. Marcus measuring up for stair opening tomorrow.',
      notes: '',
      photos: 3,
      issues: []
    }],
    changeOrders: [{
      id: 'CO-001',
      projectId: 1,
      title: 'Upgrade kitchen sockets to spec',
      amount: 1450,
      status: 'approved',
      requested: '2026-05-15',
      approvedBy: 'Adrian',
      reason: 'Client requested USB-C integrated sockets across kitchen'
    }, {
      id: 'CO-002',
      projectId: 1,
      title: 'Additional radiator — utility',
      amount: 680,
      status: 'pending',
      requested: '2026-05-21',
      reason: 'Client added utility radiator after walk-through'
    }, {
      id: 'CO-003',
      projectId: 2,
      title: 'Velux upgrade x2',
      amount: 1200,
      status: 'approved',
      requested: '2026-04-28',
      approvedBy: 'Adrian',
      reason: 'Upgraded to integra electric units'
    }],
    snags: [{
      id: 1,
      projectId: 3,
      title: 'Skirting gap at WC threshold',
      area: 'WC',
      priority: 'low',
      status: 'open',
      assignee: 'Tom',
      ...
      id: 2,
      projectId: 3,
      title: 'Paint touch-up below window — main',
      area: 'Front',
      priority: 'med',
      status: 'open',
      assignee: 'Lila',
      ...
      id: 3,
      projectId: 3,
      title: 'Door handle loose — back room',
      area: 'Back room',
      priority: 'low',
      status: 'fixed',
      assignee: 'Tom',
      ...
      id: 4,
      projectId: 3,
      title: 'Tile grout reset — kitchen',
      area: 'Kitchen',
      priority: 'med',
      status: 'open',
      assignee: 'Jack',
      ...
      id: 5,
      projectId: 1,
      title: 'Floor protection torn — hallway',
      area: 'Hall',
      priority: 'high',
      status: 'open',
      assignee: 'Tom',
    ...
    notifications: [{
      id: 1,
      kind: 'alert',
      t: 'RAMS expires Saturday',
      sub: 'Camden Mews — sign-off needed',
      ...
      id: 2,
      kind: 'money',
      t: 'INV-2039 is 14 days overdue',
      sub: 'Tonic Café · £3,890',
      ...
      id: 3,
      kind: 'task',
      t: 'Tom uploaded 4 photos',
      sub: 'Camden — first-fix kitchen',
      ...
      id: 4,
      kind: 'ai',
      t: 'Cortex flagged margin slip',
      sub: 'Brixton −1.2% vs quote',
      ...
      id: 5,
      kind: 'team',
      t: 'Sara Khan CSCS expires soon',
      sub: 'In 6 weeks · book renewal',
      when: '2026-05-21T16:40',
      read: true,
      color: '#06b6d4',
      action: 'safety'
    }, {
      id: 6,
      kind: 'quote',
      t: 'B. Khoury opened your quote',
      sub: 'Q-2117 · Islington Extension',
      when: '2026-05-21T11:20',
      read: true,
      color: '#10b981',
      action: 'quotes'
    }],
  ...
  const internalMakeTable = name => ({
    list: async () => {
      ...
      return [...Backend.db.snapshot()[name]];
    },
    ...
    updateSync: (id, patch) => {
      ...
      Backend.db.user.update({});
      if (window.cortexxCloud) {
        const item = s[name].find(x => x.id == id);
        window.cortexxCloud.push(name, 'update', id, item);
      }
    },
    remove: async id => {
      const s = Backend.db.snapshot();
  ...
  tableNames.forEach(n => {
    Backend.db[n] = internalMakeTable(n);
  });
...
const _formatRelDate = iso => {
  ...
  if (days > 0 && days < 7) return d.toLocaleDateString('en-GB', {
    weekday: 'long'
  });
