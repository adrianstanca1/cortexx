    ...
    <div style={{ padding: '8px 0 100px' }}>
      ...
      <div style={{ padding: '8px 20px 12px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <div style={{ fontFamily: SF, fontSize: 22, fontWeight: 700, color: 'var(--t1)', letterSpacing: '-0.03em' }}>Books</div>
        ...
        <div style={{ fontFamily: SF, fontSize: 13, color: 'var(--t2)', marginTop: 2 }}>Wk {wk} · CIS aware</div>
      </div>

      {/* Big money number */}
      <div style={{ padding: '8px 20px 16px' }}>
        <div style={{ fontFamily: SF, fontSize: 11, color: 'var(--t2)', fontWeight: 700, textTransform: 'uppercase', letterSpacing: 1 }}>
          Net cashflow · {monthName}
        </div>
        <div style={{ display: 'flex', alignItems: 'baseline', gap: 8, marginTop: 6 }}>
          <span style={{
            fontFamily: SFMono, fontSize: 48, fontWeight: 700,
            color: net >= 0 ? 'var(--t1)' : '#ef4444',
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginTop: 8, fontFamily: SF, fontSize: 13, color: '#10b981', fontWeight: 500 }}>
          ...
          <span style={{ color: 'var(--t3)', marginLeft: 4 }}>· {daysLeft} day{daysLeft === 1 ? '' : 's'} left</span>
        </div>
      ...
      <div style={{ padding: '0 16px 14px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
        <div style={{ background: 'rgba(16,185,129,0.10)', border: '0.5px solid rgba(16,185,129,0.33)', borderRadius: 14, padding: 12 }}>
          ...
          <div style={{ fontFamily: SFMono, fontSize: 22, fontWeight: 700, color: 'var(--t1)', marginTop: 4, letterSpacing: -0.5 }}>{fmt(cashflow)}</div>
        ...
        <div style={{ background: 'rgba(239,68,68,0.10)', border: '0.5px solid rgba(239,68,68,0.33)', borderRadius: 14, padding: 12 }}>
          ...
          <div style={{ fontFamily: SFMono, fontSize: 22, fontWeight: 700, color: 'var(--t1)', marginTop: 4, letterSpacing: -0.5 }}>{fmt(totalSpent)}</div>
          <div style={{ fontFamily: SF, fontSize: 11, color: 'var(--t2)', marginTop: 1 }}>materials + wages</div>
        </div>
      </div>
      ...
      {outstanding.length > 0 && (
        <>
          <div style={{ padding: '0 20px 8px', display: 'flex', justifyContent: 'space-between', alignItems: 'baseline' }}>
            <span style={{ fontFamily: SF, fontSize: 13, fontWeight: 700, color: 'var(--t2)', textTransform: 'uppercase', letterSpacing: 0.6 }}>
          ...
          <div style={{ padding: '0 16px', display: 'flex', flexDirection: 'column', gap: 6 }}>
            {outstanding.map(iv => {
              ...
              const col = iv.status === 'overdue' ? '#ef4444' : days <= 3 ? '#f59e0b' : 'var(--t1)'
              ...
              return (
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ fontFamily: SFMono, fontSize: 11, color: 'var(--t2)', fontWeight: 600 }}>{iv.number}</div>
                    <div style={{ fontFamily: SF, fontSize: 13, color: 'var(--t1)', fontWeight: 500, marginTop: 1 }}>
                  ...
                  <div style={{ textAlign: 'right' }}>
                    ...
                    <div style={{ fontFamily: SF, fontSize: 10, color: 'var(--t3)', marginTop: 1 }}>{daysLabel}</div>
                  </div>
